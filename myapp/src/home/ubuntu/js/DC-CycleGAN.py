...
from tensorflow.keras.models import Model as Network
import numpy as np
...
import tensorflow as tf
from keras.layers import Lambda, Softmax, dot, Permute, Reshape, Multiply
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset_path',
        type=str,
        default='/home/ubuntu/js/dataset',
        help='training dataset path'
    )
    parser.add_argument(
        '--save_image_path',
        type=str,
        default='/home/ubuntu/js/train_image/images_trip_cessim',
        help='set save temporary image path'
    )
    parser.add_argument(
        '--save_model',
        type=str,
        default='/home/ubuntu/js/',
